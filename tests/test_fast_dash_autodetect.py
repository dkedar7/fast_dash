...
def test_fdco002_hint_is_not_of_type_type(dash_duo):
    ...
    assert input_component.__doc__ == dbc.Input().__doc__ and \
           not hasattr(input_component, 'type')
...
def test_fdco003_input_is_image(dash_duo):
    ...
    app = FastDash(callback_fn=simple_image)
    input_component = app.inputs_with_ids[0]
    assert input_component.__doc__ == UploadImage.__doc__ and \
        input_component.ack.__doc__ == html.Img.__doc__
...
def test_fdco004_input_hint_is_text(dash_duo):
    ...
    app = FastDash(callback_fn=simple_text)
    input_component = app.inputs_with_ids[0]
    assert input_component.__doc__ == Text.__doc__ and \
            hasattr(input_component, 'value') and \
            input_component.value == 'Default text'
    ...
    input_component = app.inputs_with_ids[0]
    assert input_component.__doc__ == dbc.Input().__doc__ and \
            hasattr(input_component, 'type') and input_component.type == 'number' and \
            hasattr(input_component, 'value') and input_component.value == 2.2
    ...
    app = FastDash(callback_fn=simple_text)
    input_component = app.inputs_with_ids[0]
    assert input_component.__doc__ == dcc.Dropdown().__doc__ and \
            hasattr(input_component, 'options') and input_component.options == ["Some text", 2.2, "45.23"]

    # 4. Default is dictionary
    def simple_text(text: str = {"This": "is", "a": "dictionary", 5: "Fast", "Dash": [1,2,3]}):
        return text

    app = FastDash(callback_fn=simple_text)
    input_component = app.inputs_with_ids[0]
    assert input_component.__doc__ == dbc.Input().__doc__ and \
            not hasattr(input_component, 'type') and \
            hasattr(input_component, 'value') and input_component.value == str({"This": "is", "a": "dictionary", 5: "Fast", "Dash": [1,2,3]})
    ...
    assert input_component.__doc__ == dbc.Input().__doc__ and \
            not hasattr(input_component, 'type') and \
            hasattr(input_component, 'value') and input_component.value == str(True)
    ...
    assert input_component.__doc__ == dbc.Input().__doc__ and \
            not hasattr(input_component, 'type') and \
            hasattr(input_component, 'value') and input_component.value == str(datetime.date(2022, 8, 11))
    ...
    assert input_component.__doc__ == dbc.Input().__doc__ and \
            not hasattr(input_component, 'type') and \
            hasattr(input_component, 'value') and input_component.value == str(datetime.datetime(2022, 8, 11, 12, 44, 56))
...
def test_fdco005_input_hint_is_numeric(dash_duo):
    ...
    app = FastDash(callback_fn=simple_num)
    input_component = app.inputs_with_ids[0]
    assert input_component.__doc__ == dcc.Slider().__doc__ and \
        hasattr(input_component, 'min') and input_component.min == 1 and \
        hasattr(input_component, 'max') and input_component.max == 10 and \
        hasattr(input_component, 'step') and input_component.step == 2
    ...
    input_component = app.inputs_with_ids[0]
    assert input_component.__doc__ == dcc.Slider().__doc__ and \
        hasattr(input_component, 'min') and input_component.min == 0 and \
        hasattr(input_component, 'max') and input_component.max == 80 and \
        hasattr(input_component, 'step') and input_component.step == 10
...
def test_fdco006_input_hint_is_sequence(dash_duo):
    ...
    assert input_component.__doc__ == dbc.Input().__doc__ and \
            not hasattr(input_component, 'type') and \
            hasattr(input_component, 'value') and input_component.value == ["This", "is", "a", "list", "2.2"]
    ...
    assert input_component.__doc__ == dcc.Dropdown().__doc__ and \
            not hasattr(input_component, 'type') and \
            hasattr(input_component, 'options') and input_component.options == ["This", "is", "a", "list", "2.2"] and \
            hasattr(input_component, 'assign_prop') and input_component.assign_prop == 'value'
    ...
    assert input_component.__doc__ == dcc.Dropdown().__doc__ and \
            not hasattr(input_component, 'type') and \
            hasattr(input_component, 'options') and input_component.options == sample_dictionary and \
            hasattr(input_component, 'assign_prop') and input_component.assign_prop == 'value'
...
def test_fdco008_input_hint_is_boolean(dash_duo):
    ...
    input_component = app.inputs_with_ids[0]
    assert input_component.__doc__ == dbc.Checkbox().__doc__ and \
            hasattr(input_component, 'value') and input_component.value == True and \
            hasattr(input_component, 'assign_prop') and input_component.assign_prop == 'value'
    ...
    input_component = app.inputs_with_ids[0]
    assert input_component.__doc__ == dbc.Checkbox().__doc__ and \
            not hasattr(input_component, 'value') and \
            hasattr(input_component, 'assign_prop') and input_component.assign_prop == 'value'
...
def test_fdco009_input_hint_is_image(dash_duo):
    ...
    input_component = app.inputs_with_ids[0]
    assert input_component.__doc__ == UploadImage.__doc__ and \
            hasattr(input_component, 'assign_prop') and input_component.assign_prop == 'contents' and \
            hasattr(input_component, 'ack') and input_component.ack.__doc__ == html.Img.__doc__ and \
            dash_duo.find_element("#img__ack").get_attribute("src") == _pil_to_b64(img)
...
def test_fdco010_input_hint_is_image_no_default(dash_duo):
    ...
    assert input_component.__doc__ == UploadImage.__doc__ and \
            hasattr(input_component, 'assign_prop') and input_component.assign_prop == 'contents' and \
            hasattr(input_component, 'ack') and input_component.ack.__doc__ == html.Img.__doc__ and \
            dash_duo.find_element("#img__ack").get_attribute("src") == None
...
def test_fdco011_input_hint_is_date(dash_duo):
    ...
    assert input_component.__doc__ == dcc.DatePickerSingle.__doc__ and \
            hasattr(input_component, 'assign_prop') and input_component.assign_prop == 'date' and \
            hasattr(input_component, 'date') and input_component.date == datetime.date(2022, 5, 4)
    ...
    assert input_component.__doc__ == dcc.DatePickerSingle.__doc__ and \
            hasattr(input_component, 'assign_prop') and input_component.assign_prop == 'date' and \
            hasattr(input_component, 'date') and input_component.date == datetime.date.today()
...
def test_fdco012_input_hint_is_unknown(dash_duo):
    ...
    assert input_component.__doc__ == dbc.Input().__doc__ and \
            not hasattr(input_component, 'type') and \
            hasattr(input_component, 'value') and input_component.value == "Some text"
    ...
    assert input_component.__doc__ == dbc.Input().__doc__ and \
            hasattr(input_component, 'type') and input_component.type == "number" and \
            hasattr(input_component, 'value') and input_component.value == 137.2736
    ...
    assert input_component.__doc__ == dcc.Dropdown().__doc__ and \
            hasattr(input_component, 'options') and input_component.options == ["These", "are", 5, "options", "to select"]
    ...
    assert input_component.__doc__ == dcc.Slider().__doc__ and \
        hasattr(input_component, 'min') and input_component.min == 1 and \
        hasattr(input_component, 'max') and input_component.max == 1000 and \
        hasattr(input_component, 'step') and input_component.step == 5
    ...
    assert input_component.__doc__ == dcc.Dropdown().__doc__ and \
            hasattr(input_component, 'options') and input_component.options == {"This": "is", "a": "dictionary", 5: "Fast", "Dash": [1,2,3]}
    ...
    assert input_component.__doc__ == dbc.Checkbox().__doc__ and \
            hasattr(input_component, 'assign_prop') and input_component.assign_prop == 'value' and \
            hasattr(input_component, 'value') and input_component.value == True
    ...
    assert input_component.__doc__ == dcc.DatePickerSingle.__doc__ and \
            hasattr(input_component, 'assign_prop') and input_component.assign_prop == 'date' and \
            hasattr(input_component, 'date') and input_component.date == datetime.date(2022, 12, 25)
...
def test_fdco013_output_hint_is_fast_component(dash_duo):
    ...
    assert output_component.__doc__ == dcc.Slider().__doc__ and \
        hasattr(output_component, 'min') and output_component.min == 0 and \
        hasattr(output_component, 'max') and output_component.max == 20 and \
        hasattr(output_component, 'step') and output_component.step == 1
...
def test_fdco014_output_hint_is_image(dash_duo):
    ...
    assert output_component.__doc__ == html.Img.__doc__ and \
            hasattr(output_component, 'assign_prop') and output_component.assign_prop == 'src'
